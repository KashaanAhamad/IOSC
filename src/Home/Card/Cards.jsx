...
//                   <p>
//                     Lorem ipsum dolor sit amet consectetur adipisicing elit.
//                     Magnam voluptates illo officiis perferendis tempore aliquam.
//                   </p>
//                 </div>
...
// import "./Cards.css"; // Import the CSS for styling
      ...
      >
        ...
        <div className="h-[130rem] w-[88.5rem]">
          ...
          >
            <div>
              <div
                className={`flip-card w-[23rem] h-[28rem] hover:scale-110 transition-all duration-500 ${isFlipped1 ? "flipped" : ""}`}
          ...
          >
            ...
            <div>
            <div
                className={`flip-card w-[23rem] h-[28rem] hover:scale-110 transition-all duration-500 ${isFlipped2 ? "flipped" : ""}`}
          ...
          >
            <div>
              <div
                className={`flip-card w-[23rem] h-[28rem] hover:scale-110 transition-all duration-500 ${isFlipped3 ? "flipped" : ""}`}
          ...
          >
            ...
            <div>
              <div
                className={`flip-card w-[23rem] h-[28rem] hover:scale-110 transition-all duration-500 ${isFlipped4 ? "flipped" : ""}`}
